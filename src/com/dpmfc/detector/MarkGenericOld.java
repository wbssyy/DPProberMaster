...
public class MarkGenericOld extends ASTVisitor {
	...
	public MarkGenericOld(String projectPath) throws Exception{
		super();
...
//		MenuBar
		MarkGenericOld markGeneric = new MarkGenericOld("D:\\test\\jdk1.4.2_src\\java\\awt");
	}
}
